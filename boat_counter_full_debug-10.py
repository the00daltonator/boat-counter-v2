...
try:                                  # 1️⃣ first look for canonical wheel
    ...
    log.info("Using Rust IOUTracker from package 'ioutrack_rs'")

except ImportError as e1:
    try:                              # 2️⃣ your wheel: ioutrack/ioutrack.so exporting Sort
        from ioutrack.ioutrack import Sort as _RustSort
        Sort = _RustSort
        import sys                    # make "ioutrack_rs" alias for any other code
        sys.modules["ioutrack_rs"] = sys.modules["ioutrack.ioutrack"]
        log.info("Using Rust IOUTracker from package 'ioutrack.ioutrack'")
